...
function DOCMaterialToWasteDOCTFMaterialList_Model(options){
	var id = 'DOCMaterialToWasteDOCTFMaterialList_Model';
	options = options || {};
	...
	options.fields.quant = field;
		...
		DOCMaterialToWasteDOCTFMaterialList_Model.superclass.constructor.call(this,id,options);
}
extend(DOCMaterialToWasteDOCTFMaterialList_Model,ModelXML);
