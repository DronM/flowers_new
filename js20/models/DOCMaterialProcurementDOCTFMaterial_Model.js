...
function DOCMaterialProcurementDOCTFMaterial_Model(options){
	var id = 'DOCMaterialProcurementDOCTFMaterial_Model';
	options = options || {};
	...
	options.fields.total = field;
		...
		DOCMaterialProcurementDOCTFMaterial_Model.superclass.constructor.call(this,id,options);
}
