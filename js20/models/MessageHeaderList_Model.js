...
function MessageHeaderList_Model(options){
	var id = 'MessageHeaderList_Model';
	options = options || {};
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Автор сообщения';options.fields.user_descr = new FieldString("user_descr",filed_options);
	...
	filed_options.alias = 'Время создания';options.fields.date_time = new FieldDateTime("date_time",filed_options);
		...
		MessageHeaderList_Model.superclass.constructor.call(this,id,options);
}
