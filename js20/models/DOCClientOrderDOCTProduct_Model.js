...
function DOCClientOrderDOCTProduct_Model(options){
	var id = 'DOCClientOrderDOCTProduct_Model';
	options = options || {};
	...
	options.fields.total = field;
		...
		DOCClientOrderDOCTProduct_Model.superclass.constructor.call(this,id,options);
}
