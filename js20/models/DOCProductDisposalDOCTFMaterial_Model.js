...
function DOCProductDisposalDOCTFMaterial_Model(options){
	var id = 'DOCProductDisposalDOCTFMaterial_Model';
	options = options || {};
	...
	options.fields.quant = field;
		...
		DOCProductDisposalDOCTFMaterial_Model.superclass.constructor.call(this,id,options);
}
