...
function DOCProductDisposalDOCTFMaterialList_Model(options){
	var id = 'DOCProductDisposalDOCTFMaterialList_Model';
	options = options || {};
	...
	options.fields.quant = field;
		...
		DOCProductDisposalDOCTFMaterialList_Model.superclass.constructor.call(this,id,options);
}
