...
function RGMaterialSale_Model(options){
	var id = 'RGMaterialSale_Model';
	options = options || {};
	...
	options.fields.cost = field;
		...
		RGMaterialSale_Model.superclass.constructor.call(this,id,options);
}
extend(RGMaterialSale_Model,ModelXML);
