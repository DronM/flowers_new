...
function DOCMaterialToWasteDOCTMaterialList_Model(options){
	var id = 'DOCMaterialToWasteDOCTMaterialList_Model';
	options = options || {};
	...
	options.fields.quant = field;
		...
		DOCMaterialToWasteDOCTMaterialList_Model.superclass.constructor.call(this,id,options);
}
extend(DOCMaterialToWasteDOCTMaterialList_Model,ModelXML);
