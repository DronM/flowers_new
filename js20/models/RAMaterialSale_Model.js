...
function RAMaterialSale_Model(options){
	var id = 'RAMaterialSale_Model';
	options = options || {};
	...
	options.fields.cost = field;
		...
		RAMaterialSale_Model.superclass.constructor.call(this,id,options);
}
extend(RAMaterialSale_Model,ModelXML);
