...
function DOCMaterialToWasteDOCTFMaterial_Model(options){
	var id = 'DOCMaterialToWasteDOCTFMaterial_Model';
	options = options || {};
	...
	options.fields.quant = field;
		...
		DOCMaterialToWasteDOCTFMaterial_Model.superclass.constructor.call(this,id,options);
}
extend(DOCMaterialToWasteDOCTFMaterial_Model,ModelXML);
