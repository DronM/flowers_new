...
function DOCMaterialToWasteList_Model(options){
	var id = 'DOCMaterialToWasteList_Model';
	options = options || {};
	...
	options.fields.explanation = field;
		...
		DOCMaterialToWasteList_Model.superclass.constructor.call(this,id,options);
}
extend(DOCMaterialToWasteList_Model,ModelXML);
