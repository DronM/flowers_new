...
function DOCExpenceExpenceTypeList_Model(options){
	var id = 'DOCExpenceExpenceTypeList_Model';
	options = options || {};
	...
	options.fields.expence_type_descr = field;
		...
		DOCExpenceExpenceTypeList_Model.superclass.constructor.call(this,id,options);
}
