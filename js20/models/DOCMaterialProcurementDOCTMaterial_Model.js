...
function DOCMaterialProcurementDOCTMaterial_Model(options){
	var id = 'DOCMaterialProcurementDOCTMaterial_Model';
	options = options || {};
	...
	options.fields.total.getValidator().setMaxLength('19');
		...
		DOCMaterialProcurementDOCTMaterial_Model.superclass.constructor.call(this,id,options);
}
