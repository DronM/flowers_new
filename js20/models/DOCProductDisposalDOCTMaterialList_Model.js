...
function DOCProductDisposalDOCTMaterialList_Model(options){
	var id = 'DOCProductDisposalDOCTMaterialList_Model';
	options = options || {};
	...
	options.fields.quant = field;
		...
		DOCProductDisposalDOCTMaterialList_Model.superclass.constructor.call(this,id,options);
}
