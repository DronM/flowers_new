...
function DOCMaterialProcurementDOCTFMaterialList_Model(options){
	var id = 'DOCMaterialProcurementDOCTFMaterialList_Model';
	options = options || {};
	...
	options.fields.total = field;
		...
		DOCMaterialProcurementDOCTFMaterialList_Model.superclass.constructor.call(this,id,options);
}
