...
function DOCNumberEdit(id,options){
	...
	options.contClassName = options.contClassName || "form-group";//options.contClassName || options.app.getBsCol(3);
	options.labelClassName = options.labelClassName || options.app.getBsCol(5);
