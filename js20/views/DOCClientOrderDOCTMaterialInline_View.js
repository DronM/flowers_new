...
*/
function DOCClientOrderDOCTMaterialInline_View(id,options){
	options = options || {};	
	
	this.m_discountPercent = (options.discountPercent!=undefined)? options.discountPercent:0;
	
	DOCClientOrderDOCTMaterialInline_View.superclass.constructor.call(this,id,options);
}
extend(DOCClientOrderDOCTMaterialInline_View, ViewGridEditInlineAjx);
...
/* public methods */
DOCClientOrderDOCTMaterialInline_View.prototype.addEditControls = function(){
	var self = this;
	var recalc = function(){
...
DOCClientOrderDOCTMaterialInline_View.prototype.setWritePublicMethod = function(pm){	
	if (pm){
