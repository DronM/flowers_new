...
function UserDialog_View(id,options){	
	...
	options.model = new UserDialog_Model({"data":options.modelDataStr});
...
*/
	...
	this.setDataBindings([
		...
		new DataBinding({"control":this.getElement("constrain_to_store"),"keyIds":["constrain_to_store"]}),
		new DataBinding({"control":this.getElement("cash_register"),"keyIds":["cash_register_id"]}),
	...
	this.getCommand(this.CMD_OK).setBindings([
		...
		new CommandBinding({"control":this.getElement("constrain_to_store"),"fieldId":"constrain_to_store"}),
