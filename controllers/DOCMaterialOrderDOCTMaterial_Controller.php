...
class DOCMaterialOrderDOCTMaterial_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL){
		...
		$this->setInsertModelId('DOCMaterialOrderDOCTMaterial_Model');
		...
		$param = new FieldExtFloat('quant'
			...
			$this->addPublicMethod($pm);
			$this->setUpdateModelId('DOCMaterialOrderDOCTMaterial_Model');
		...
		$this->addPublicMethod($pm);					
		$this->setDeleteModelId('DOCMaterialOrderDOCTMaterial_Model');
		...
		$this->setListModelId('DOCMaterialOrderDOCTMaterialList_Model');
		...
		$this->addPublicMethod($pm);
		$this->setObjectModelId('DOCMaterialOrderDOCTMaterialList_Model');		
