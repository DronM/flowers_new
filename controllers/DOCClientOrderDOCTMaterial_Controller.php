...
class DOCClientOrderDOCTMaterial_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL){
		...
		$this->setInsertModelId('DOCClientOrderDOCTMaterial_Model');
		...
		$param = new FieldExtFloat('total'
			...
			$this->addPublicMethod($pm);
			$this->setUpdateModelId('DOCClientOrderDOCTMaterial_Model');
		...
		$this->addPublicMethod($pm);					
		$this->setDeleteModelId('DOCClientOrderDOCTMaterial_Model');
		...
		$this->setListModelId('DOCClientOrderDOCTMaterialList_Model');
		...
		$this->addPublicMethod($pm);
		$this->setObjectModelId('DOCClientOrderDOCTMaterialList_Model');		
