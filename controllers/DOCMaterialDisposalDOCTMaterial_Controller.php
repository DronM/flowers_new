...
class DOCMaterialDisposalDOCTMaterial_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL){
		...
		$this->setInsertModelId('DOCMaterialDisposalDOCTMaterial_Model');
		...
		$param = new FieldExtFloat('quant'
			...
			$this->addPublicMethod($pm);
			$this->setUpdateModelId('DOCMaterialDisposalDOCTMaterial_Model');
		...
		$this->addPublicMethod($pm);					
		$this->setDeleteModelId('DOCMaterialDisposalDOCTMaterial_Model');
		...
		$this->setListModelId('DOCMaterialDisposalDOCTMaterialList_Model');
		...
		$this->addPublicMethod($pm);
		$this->setObjectModelId('DOCMaterialDisposalDOCTMaterialList_Model');		
