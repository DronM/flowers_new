...
class DOCMaterialToWaste_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL){
		...
		$this->setInsertModelId('DOCMaterialToWaste_Model');
		...
		$param = new FieldExtText('explanation'
			...
			$this->addPublicMethod($pm);
			$this->setUpdateModelId('DOCMaterialToWaste_Model');
		...
		$this->addPublicMethod($pm);					
		$this->setDeleteModelId('DOCMaterialToWaste_Model');
		...
		$this->setListModelId('DOCMaterialToWasteList_Model');
		...
		$this->addPublicMethod($pm);
		$this->setObjectModelId('DOCMaterialToWasteList_Model');		
