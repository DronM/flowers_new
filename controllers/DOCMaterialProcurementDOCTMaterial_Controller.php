...
class DOCMaterialProcurementDOCTMaterial_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL){
		...
		$this->setInsertModelId('DOCMaterialProcurementDOCTMaterial_Model');
		...
		$param = new FieldExtFloat('total'
			...
			$this->addPublicMethod($pm);
			$this->setUpdateModelId('DOCMaterialProcurementDOCTMaterial_Model');
		...
		$this->addPublicMethod($pm);					
		$this->setDeleteModelId('DOCMaterialProcurementDOCTMaterial_Model');
		...
		$this->setListModelId('DOCMaterialProcurementDOCTMaterialList_Model');
		...
		$this->addPublicMethod($pm);
		$this->setObjectModelId('DOCMaterialProcurementDOCTMaterialList_Model');		
