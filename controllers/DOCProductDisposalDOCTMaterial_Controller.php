...
class DOCProductDisposalDOCTMaterial_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL){
		...
		$this->setInsertModelId('DOCProductDisposalDOCTMaterial_Model');
		...
		$param = new FieldExtFloat('quant'
			...
			$this->addPublicMethod($pm);
			$this->setUpdateModelId('DOCProductDisposalDOCTMaterial_Model');
		...
		$this->addPublicMethod($pm);					
		$this->setDeleteModelId('DOCProductDisposalDOCTMaterial_Model');
		...
		$this->setListModelId('DOCProductDisposalDOCTMaterialList_Model');
		...
		$this->addPublicMethod($pm);
		$this->setObjectModelId('DOCProductDisposalDOCTMaterialList_Model');		
