-- Function: reg_material_set_custom_period(timestamp without time zone)

-- DROP FUNCTION reg_material_set_custom_period(timestamp without time zone);

CREATE OR REPLACE FUNCTION reg_material_set_custom_period(in_new_period timestamp without time zone)
  RETURNS void AS
$BODY$
DECLARE
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION reg_material_set_custom_period(timestamp without time zone)
  OWNER TO bellagio;
