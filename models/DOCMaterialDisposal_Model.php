...
class DOCMaterialDisposal_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("doc_material_disposals");
		...
		$f_explanation=new FieldSQLText($this->getDbLink(),$this->getDbName(),$this->getTableName(),"explanation",$f_opts);
