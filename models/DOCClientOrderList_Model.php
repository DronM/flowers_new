...
class DOCClientOrderList_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$f_delivery_type=new FieldSQLString($this->getDbLink(),$this->getDbName(),$this->getTableName(),"delivery_type",$f_opts);
		...
		$f_recipient_type=new FieldSQLString($this->getDbLink(),$this->getDbName(),$this->getTableName(),"recipient_type",$f_opts);
		...
		//*** Field delivery_hour_descr ***
		$f_opts = array();
		$f_opts['id']="delivery_hour_descr";
		
		$f_delivery_hour_descr=new FieldSQLString($this->getDbLink(),$this->getDbName(),$this->getTableName(),"delivery_hour_descr",$f_opts);
		...
		$f_delivery_note_type=new FieldSQLString($this->getDbLink(),$this->getDbName(),$this->getTableName(),"delivery_note_type",$f_opts);
		...
		$f_delivery_comment=new FieldSQLText($this->getDbLink(),$this->getDbName(),$this->getTableName(),"delivery_comment",$f_opts);
		...
		$f_payment_type=new FieldSQLString($this->getDbLink(),$this->getDbName(),$this->getTableName(),"payment_type",$f_opts);
		...
		$f_client_order_state=new FieldSQLString($this->getDbLink(),$this->getDbName(),$this->getTableName(),"client_order_state",$f_opts);
