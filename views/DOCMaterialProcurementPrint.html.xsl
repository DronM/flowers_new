...
<h3>Поступление материалов №<xsl:value-of select="row/number"/> от <xsl:value-of select="row/date_time_descr"/></h3>
<div>
	<p>
		<span>Салон:</span>
	...
	<p>
		<span>Поставщик:</span>
		<span><xsl:value-of select="row/supplier_descr"/></span>
	</p>	
	<p>
		<span>Автор:</span>
