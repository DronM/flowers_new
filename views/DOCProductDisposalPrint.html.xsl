...
<h3>Разукомплектация №<xsl:value-of select="row/number"/> от <xsl:value-of select="row/date_time_descr"/></h3>
<div>
	<p>
		<span>Салон:</span>
	...
	<p>
		<span>Букет:</span>
		<span><xsl:value-of select="row/product_descr"/></span>
	</p>
	<p>
		<span>Цена:</span>
		<span><xsl:value-of select="row/price"/></span>
	</p>
	<p>	
		<span>Комплектация: №<xsl:value-of select="row/doc_production_number"/> от <xsl:value-of select="row/doc_production_date_time"/></span>
	</p>		
	<p>
		<span>Причина:</span>
		<span><xsl:value-of select="row/explanation"/></span>
	</p>			
	<p>
		<span>Автор:</span>
