...
<h3>Товарный чек №<xsl:value-of select="row/number"/> от <xsl:value-of select="row/date_time_descr"/></h3>
<div>
	<p>
		<span>Салон:</span>
	...
	<p>
		...
		<span><xsl:value-of select="row/payment_type_for_sale_descr"/></span>
	</p>		
	<p>
		<span>Автор:</span>
